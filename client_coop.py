...
class FlowerCliente(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        versao_recebida = config.get("versao_global", 0)
        ...
        metricas_do_cliente = {
            "versao_treinada": versao_recebida
        }

        return self.get_parameters(config={}), len(self.trainloader.dataset), metricas_do_cliente

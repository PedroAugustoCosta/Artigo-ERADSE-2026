...
from client_FSVRG import generate_client_fn
from dataset_non_iid import prepare_dataset
from server import get_on_fit_config,get_evaluate_fn
from strategies.fsvrg import AlgoritmoFSVRG
...
def main(cfg: DictConfig):
    ...
    print(f"Chaves na estratégia: {cfg.strategy.keys()}")
    ...
    print(f"Tipo da estratégia: {type(strategy)}")
    print(f"Atributos da estratégia: {dir(strategy)}")
    # Inicia a simulação
